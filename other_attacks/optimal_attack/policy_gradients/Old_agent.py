...
class Trainer():
    ...
    def __init__(self, policy_net_class, value_net_class, params,
                 store, environment, start_state, advanced_logging=True, log_every=5):
        '''
...
#                    next_adv_perturbation_log_probs = self.adversary_policy_model.get_loglikelihood(adv_perturbation_pds, next_adv_perturbations)
    ...
    @staticmethod
    def agent_from_params(params, environment, start_state, store=None):
        '''
        ...
        p = Trainer(agent_policy, agent_value, params, store, environment, start_state, log_every=log_every,
