...
PPO_attack.save_attack("Adv_Traj/Cheetah_PPO_State+Time")

ATLA_attack.generate(num_traj=10)
ATLA_attack.save_attack("Adv_Traj/Cheetah_ATLA_State+Time")

LSTM_attack.generate(num_traj=10)
LSTM_attack.save_attack("Adv_Traj/Cheetah_LSTM_State+Time")
...
PPO_attack.generate(num_traj=10)
PPO_attack.save_attack("Adv_Traj/Hopper_PPO_State+Time")

ATLA_attack.generate(num_traj=10)
ATLA_attack.save_attack("Adv_Traj/Hopper_ATLA_State+Time")

LSTM_attack.generate(num_traj=10)
LSTM_attack.save_attack("Adv_Traj/Hopper_LSTM_State+Time")
...
PPO_attack.generate(num_traj=10)
PPO_attack.save_attack("Adv_Traj/Walker_PPO_State+Time")

ATLA_attack.generate(num_traj=10)
ATLA_attack.save_attack("Adv_Traj/Walker_ATLA_State+Time")

LSTM_attack.generate(num_traj=10)
LSTM_attack.save_attack("Adv_Traj/Walker_LSTM_State+Time")
...
PPO_attack.generate(num_traj=10)
PPO_attack.save_attack("Adv_Traj/Ant_PPO_State+Time")

ATLA_attack.generate(num_traj=10)
ATLA_attack.save_attack("Adv_Traj/Ant_ATLA_State+Time")

LSTM_attack.generate(num_traj=10)
LSTM_attack.save_attack("Adv_Traj/Ant_LSTM_State+Time")
